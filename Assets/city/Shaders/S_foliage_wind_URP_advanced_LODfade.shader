...
Shader "TidalFlask/Foliage Wind URP Advanced LODfade City"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				#else
				float staticSwitch441 = v.ase_color.a;
				#endif
				float4 lerpResult3 = lerp( float4( ase_worldPos , 0.0 ) , appendResult51 , staticSwitch441);
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 bakedGI438 = ASEBakedGI( ase_worldNormal, float2( 0,0 ), true);
				float3 temp_output_411_0 = ( saturate( ( temp_output_416_0 * ase_lightColor.rgb ) ) + localAdditionalLightsFlat12x118_g1 + bakedGI438 );
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.CommentaryNode;79;-4987.675,83.78412;Inherit;False;3971.5;1271.156;;25;52;441;440;77;1;3;51;54;48;41;49;42;39;50;38;35;46;34;225;222;33;44;221;219;218;wind movement;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.VertexColorNode;440;-2709.256,867.374;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;52;-2724.574,1058.223;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;441;-2430.487,855.3777;Inherit;False;Property;_Usevertexcolorforwind;Use vertex color for wind;7;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;90;-850.5701,-1339.557;Inherit;False;2658.167;515.884;;17;167;80;419;421;410;75;416;411;96;95;93;116;72;73;63;425;438;custom lighting;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.BakedGINode;438;536.886,-996.5115;Inherit;False;True;5;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;411;829.321,-1200.904;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;439;410.7936,-1456.791;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=9AC10B5E70280161C288A1C94F38051792BEB550